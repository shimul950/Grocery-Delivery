import { ArrowUpRight, ArrowUpRightIcon, BikeIcon, ChevronDownIcon, LogOutIcon, MapPinIcon, MenuIcon, PackageIcon, SearchIcon, ShieldIcon, ShoppingCartIcon, UserIcon, XIcon } from "lucide-react";
...
export default function Navbar() {
    ...
    const user: any = { name: "Abu Bakkar", email: "abubakkar@example.com", isAdmin: true }
                        ...
                        <div className="relative">
                            ...
                            {userMenuOpen && (
                                <>
                                    ...
                                    <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in">
                                        {user && (
